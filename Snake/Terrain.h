...
enum TerrainType{TERRAIN_RANDOM, TERRAIN_FLAT, TERRAIN_TEST, TERRAIN_UPHILL, TERRAIN_DOWNHILL, TERRAIN_DEBRIS, TERRAIN_DEBRIS_SMALL, TERRAIN_SMALLHILL, TERRAIN_LARGEHILL};
